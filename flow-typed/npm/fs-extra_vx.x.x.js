// flow-typed signature: 6e0e9ef71656e4ef13abe9ed36c9a59c
// flow-typed version: <<STUB>>/fs-extra_v11.1.0/flow_v0.105.0
 ...
 * needed.
 */
declare module 'fs-extra/lib/copy/copy-sync' {
  declare module.exports: any;
}
...
declare module 'fs-extra/lib/move/move-sync' {
  declare module.exports: any;
}
...
declare module 'fs-extra/lib/output-file' {
  declare module.exports: any;
}
...
// Filename aliases
declare module 'fs-extra/lib/copy/copy-sync.js' {
  declare module.exports: $Exports<'fs-extra/lib/copy/copy-sync'>;
}
...
declare module 'fs-extra/lib/move/move-sync.js' {
  declare module.exports: $Exports<'fs-extra/lib/move/move-sync'>;
}
declare module 'fs-extra/lib/move/move.js' {
  declare module.exports: $Exports<'fs-extra/lib/move/move'>;
}
declare module 'fs-extra/lib/output-file/index' {
  declare module.exports: $Exports<'fs-extra/lib/output-file'>;
}
declare module 'fs-extra/lib/output-file/index.js' {
  declare module.exports: $Exports<'fs-extra/lib/output-file'>;
}
