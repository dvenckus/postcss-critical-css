 ...
 */
function getCriticalRules(css, defaultDest, destDelim) {
  ...
  css.walkDecls("critical-selector", function (decl) {
    ...
    var targets = (0, _getCriticalDestination.getCriticalDestination)(parent, defaultDest);
    var destList = targets.split(destDelim);
